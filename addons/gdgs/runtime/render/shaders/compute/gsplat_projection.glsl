...
const int PROJECTION_MODE_INSTANCE_DATA_ONLY = 6;
const int PROJECTION_MODE_MODEL_MATRIX_ONLY = 7;
const int PROJECTION_MODE_SPLAT_PAYLOAD_ONLY = 8;
const int PROJECTION_MODE_DUMMY_OUTPUT_WRITE_ONLY = 9;
