...
const int PROJECTION_MODE_INSTANCE_DATA_BLOCK_ONLY = 5;
const int PROJECTION_MODE_PRE_INSTANCE_READ_PROBE_ONLY = 6;
const int PROJECTION_MODE_INSTANCE_DATA_TOUCH_ONLY = 7;
const int PROJECTION_MODE_INSTANCE_DATA_ONLY = 8;
const int PROJECTION_MODE_MODEL_MATRIX_ONLY = 9;
const int PROJECTION_MODE_SPLAT_PAYLOAD_ONLY = 10;
const int PROJECTION_MODE_DUMMY_OUTPUT_WRITE_ONLY = 11;
