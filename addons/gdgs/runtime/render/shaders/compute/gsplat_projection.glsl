...
const int PROJECTION_MODE_INSTANCE_DATA_BLOCK_ONLY = 3;
const int PROJECTION_MODE_INSTANCE_DATA_ONLY = 4;
const int PROJECTION_MODE_MODEL_MATRIX_ONLY = 5;
const int PROJECTION_MODE_SPLAT_PAYLOAD_ONLY = 6;
const int PROJECTION_MODE_DUMMY_OUTPUT_WRITE_ONLY = 7;
